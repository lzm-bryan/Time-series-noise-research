...
Y_train_noisy_inv = inverse_transform(Y_train_noisy.cpu().numpy(), data, scaler)
Y_train = inverse_transform(Y_train.reshape(-1, 1), data, scaler)
val_predict = inverse_transform(val_predict, data, scaler)
Y_val_noisy_inv = inverse_transform(Y_val_noisy.cpu().numpy(), data, scaler)
Y_val = inverse_transform(Y_val.reshape(-1, 1), data, scaler)
test_predict = inverse_transform(test_predict, data, scaler)
Y_test = inverse_transform(Y_test.cpu().numpy(), data, scaler)
